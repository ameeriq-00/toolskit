...
const MostVisitedSitesDashboard = ({ sites }) => {
  ...
  const stats = {
    ...
    mostActiveCity: Object.entries(cityGroups).sort(
  ...
  const filteredSites =
    selectedCity === "all" ? sites : cityGroups[selectedCity]?.sites || [];
              ...
              <Table>
                <TableHead>
                  <TableRow sx={{ backgroundColor: "primary.main" }}>
                    ...
                    <TableCell sx={{ color: "white", fontWeight: "bold" }}>
                      {strings.siteLocation}
                    </TableCell>
                    <TableCell
                      sx={{ color: "white", fontWeight: "bold" }}
                      align="right"
                    >
                      {strings.numberOfVisits}
                    </TableCell>
                    <TableCell sx={{ color: "white", fontWeight: "bold" }}>
                      {strings.siteCoordinates}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
